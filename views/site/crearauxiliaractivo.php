...
font-family: Georgia, serif;
    ...
    color: #996600;
    font-size: 80px;">Crear Activo</h1>
...
<div class="form-group">
    ...
    <?= 
        ...
        ['prompt'=>'Seleccione un activo']
        )->label('Seleccione el tipo de activo')?>

        <a href="#">Crear un nuevo tipo de activo</a>
</div>


<div class="form-group">
 <?= $form->field($model, "estado")->dropDownList(['ocioso'=>'Ocioso','activo'=>'Activo'],['prompt'=>'Seleccione un estado']) ?>   
</div>
...
<div class="form-group">
    ...
    <?= 
       ...
       <div class="col-sm-4"></div>
        <div class="col-sm-3">
       <?= Html::submitButton("Crear Activo", ["class" => "btn btn-primary"]) ?>
